    ...
    <>
      ...
      <div className="col-span-12 lg:col-span-8 grid grid-cols-1 gap-4">
        {[
          ...
          <div key={idx} className={`${item.bg} rounded-bento p-10 border flex flex-col justify-center min-h-[300px] transition-all duration-500 shadow-xl`}>
        ...
        <div className={`${isDarkMode ? 'bg-white text-black' : 'bg-gray-900 text-white'} rounded-bento p-12 flex flex-col md:flex-row items-center justify-between relative overflow-hidden group shadow-2xl transition-all`}>

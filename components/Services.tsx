...
export function Services({ isDarkMode }: ServicesProps) {
  ...
  return (
    <>
      <div className={`${cardAccent} col-span-12 lg:col-span-4 rounded-bento p-12 border border-transparent h-[600px] flex flex-col justify-between group transition-all`}>
      ...
      <div className="col-span-12 lg:col-span-8 grid grid-cols-2 gap-4">
        {[
          { title: t('services.mobileOrdering'), icon: 'M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z', bg: cardPrimary },
          { title: t('services.dataAnalytics'), icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z', bg: isDarkMode ? 'bg-[#2a2a2a] border-white/5' : 'bg-gray-100 border-gray-200' }
        ].map((item, idx) => (
          <div key={idx} className={`${item.bg} rounded-bento p-10 border flex flex-col justify-center transition-all duration-500 shadow-xl`}>
            <div className="w-16 h-16 bg-amber-500 rounded-3xl flex items-center justify-center mb-8 shadow-lg shadow-amber-500/20">
              <svg className="w-8 h-8 text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d={item.icon}/></svg>
            </div>
        ...
        <div className={`${isDarkMode ? 'bg-white text-black' : 'bg-gray-900 text-white'} col-span-2 rounded-bento p-12 flex flex-col md:flex-row items-center justify-between relative overflow-hidden group shadow-2xl transition-all`}>

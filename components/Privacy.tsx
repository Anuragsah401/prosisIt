...
export function Privacy({ isDarkMode }: PrivacyProps) {
  ...
  return (
    <>
      <AnimatedBox
        className={`${cardPrimary} col-span-12 rounded-bento p-12 border flex flex-col justify-center min-h-[300px] transition-all`}
        index={0}
      >
      ...
      <AnimatedBox
        className={`${cardSecondary} col-span-12 lg:col-span-6 rounded-bento p-12 border transition-all`}
        index={1}
      >
      ...
      <AnimatedBox
        className={`${cardAccent} col-span-12 lg:col-span-6 rounded-bento p-12 border border-transparent flex flex-col justify-between transition-all`}
        index={2}
      >
        <div>
